      ...
      {groupItems.map((item, index) => {
        ...
        return (
          <button
            type="button"
            className={cn(
              "bg-white text-secondary-900 ring-secondary-300 hover:bg-secondary-100 relative inline-flex items-center px-3 py-2 text-sm font-semibold ring-1 ring-inset focus:z-10",
