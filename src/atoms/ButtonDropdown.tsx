...
interface ButtonDropdownProps {
  groupItems: ButtonDropdownItem[];
}

export function ButtonDropdown({ groupItems }: ButtonDropdownProps) {
  return (
    <div className="inline-flex rounded-md shadow-sm">
      <button
        type="button"
        className="hover:bg-secondary-100 relative inline-flex items-center bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-10"
